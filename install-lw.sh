...
${prefix}XUI_MEMORY_LIMIT="64"
${prefix}XUI_GOGC="25"
${prefix}XUI_MEMORY_RELEASE_INTERVAL="3"
${prefix}XUI_DB_CACHE_MB="4"
${prefix}XUI_DB_MMAP_MB="0"
${prefix}XUI_DB_TEMP_STORE="FILE"
${prefix}XUI_DB_MAX_OPEN_CONNS="2"
${prefix}XUI_DB_MAX_IDLE_CONNS="1"
${prefix}GODEBUG="madvdontneed=1"
EOF
  chmod 0644 "$env_file"
}
